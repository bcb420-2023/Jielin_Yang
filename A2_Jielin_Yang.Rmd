...
heatmap_matrix_vtp_ctrl <- heatmap_matrix[rownames(dge_vtp_ctrl), 
...
**Figure 6.** Heatmap of differentially expressed genes comparing VTP treatment to
...
**Figure 7.** Volcano plot of differentially expressed genes under VTP treatment 
...
# Extract the differentially expressed genes from the heatmap matrix
heatmap_matrix_vtp_tgf <- heatmap_matrix[rownames(dge_vtp_tgf), 
...
**Figure 8.** Heatmap of differentially expressed genes under VTP treatment in the
presence of TGF-β1.
