...
DT::datatable(vtp_ctrl_up, rownames = TRUE, filter = "top",
...
DT::datatable(vtp_ctrl_down, rownames = TRUE, filter = "top",
              options = list(pageLength = 5, scrollX = TRUE)) %>%
              # Changing the font size of content
...
upregulated genes are ``r paste(rownames(vtp_ctrl_up[1:5]), collapse = ", ")``, and th
