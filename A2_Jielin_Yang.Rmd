...
it is clear that the two clusters show consistant changes in up and down regulation
of a defined set of genes, but the dergree to which the change is observed is
...
However, dipite the clustering of samples, a clear pattern of up and down-regulated
