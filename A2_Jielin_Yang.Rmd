...
write.table(rownames(deg_vtp_ctrl),
            file = "./Data/deg_vtp_ctrl_FDR.txt", quote = FALSE, 
            row.names = FALSE, col.names = FALSE)

# Extract a gene list with thresholded FDR < 0.05 for up-regulated genes
write.table(rownames(deg_vtp_ctrl[deg_vtp_ctrl$logFC > 0, ]),
            file = "./Data/deg_vtp_ctrl_FDR_upreg.txt", quote = FALSE, 
            row.names = FALSE, col.names = FALSE)

# Extract a gene list with thresholded FDR < 0.05 for down-regulated genes
write.table(rownames(deg_vtp_ctrl[deg_vtp_ctrl$logFC < 0, ]),
            file = "./Data/deg_vtp_ctrl_FDR_downreg.txt", quote = FALSE, 
            row.names = FALSE, col.names = FALSE)
```
