...
related to the top expressed genes we previously identified. Therefore, we will
proceed to data normalization while keeping these genes in the dataset.

Finally, we save a newly mapped version of the filtered CPM table.

```{r, message = FALSE, tidy=TRUE}
file <- "./Data/cpm_filtered_translated.csv"
write.csv(cpm_filtered_translated[ , 2:26], file, row.names = FALSE)
```
