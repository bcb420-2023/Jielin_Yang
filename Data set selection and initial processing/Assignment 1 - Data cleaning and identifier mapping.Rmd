...
if (! file.exists("./Data/GSE203358_Count_Matrix.txt")) {
  GEOquery::getGEOSuppFiles(geoAcc, makeDirectory = FALSE, baseDir = "./Data")
  GEOquery::gunzip("./Data/GSE203358_Count_Matrix.txt.gz")
}
...
located in the file: `GSE203358_Count_Matrix.txt`
