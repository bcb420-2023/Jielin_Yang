...
into the project directory of the container

```{r}
# Check if a database already exists
if(!file.exists('/home/rstudio/projects/GEOmetadb.sqlite')) 
    GEOmetadb::getSQLiteFile()
# Display the version of the database
file.info("/home/rstudio/projects/GEOmetadb.sqlite")

# Connect to the database using an absolute path to the file
con <- DBI::dbConnect(RSQLite::SQLite(), 
                      '/home/rstudio/projects/GEOmetadb.sqlite')
```
