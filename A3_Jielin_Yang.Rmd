...
gsea_vtp_tgf_up <- read.csv("./Data/VTPTGFPreranked/gsea_report_for_na_pos_1680319898865.csv",
    header = TRUE)
gsea_vtp_tgf_down <- read.csv("./Data/VTPTGFPreranked/gsea_report_for_na_neg_1680319898865.csv", 
    header = TRUE)
```
